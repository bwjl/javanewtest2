...
public class Rsa {
    ...
    public Rsa() {
        ...
        rootPath = getClass().getClassLoader().getResource("").toString();
        //priKey = readStringFromFile(rootPath + "java_private.pem");
//        String fileName = getClass().getResource("java_private.pem").getPath();
//        System.out.println(fileName);
        System.out.println(rootPath);

        String fileName = rootPath + "java_private.pem";
        System.out.println(fileName);

        priKey = readStringFromFile(fileName);
    ...
    private String base64encode(byte[] bstr) {
        ...
        String str = new String(Base64.encodeBase64(bstr));
...
//            bt = decoder.decodeBuffer(str);
            //decodeBase64 new String(Base64.encodeBase64(bstr));
